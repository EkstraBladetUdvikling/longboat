...
export type TLongboatEvent =
  | IExtendedArtikelInviewSchema
  | IExtendedContentInviewSchema
  | IExtendedDrEditionClickSchema
  | IExtendedEventSchema
  | IExtendedExternalLinksSchema
  | IExtendedGalleryClickSchema
  | IExtendedListeClicksSchema
  | IExtendedMitEbSchema
  | IExtendedPageviewSchema
  | IExtendedPixelInviewSchema
  | IExtendedPlusPayflowSchema
  | IExtendedRelateredeLinksSchema
  | IExtendedScrollSchema
  | IExtendedSpaceManagementSchema
  | IExtendedTopmenuSchema
  | IExtendedVideoSchema;

export declare type TAllLongboatProps =
  | ArtikelInviewSchema
  | ContentInviewSchema
  | DrEditionClickSchema
  | EventSchema
  | ExternalLinksSchema
  | GalleryClickSchema
  | ListeClicksSchema
  ...
  | PixelInviewSchema
  | PlusPayflowSchema
  | RelateredeLinksSchema
  | ScrollSchema
  | SpaceManagementSchema
  | TopmenuSchema
  | VideoSchema;
